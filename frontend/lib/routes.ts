...
export const MODULES: ModuleRoute[] = [
  ...
  }, */
  {
    ...
    permission: 'hr',
    sub: [
      { label: 'Setup',        path: '/hr/setup',        icon: Building2,    permission: 'hr' },
      { label: 'Directory',    path: '/hr/directory',    icon: Users,        permission: 'hr' },
      { label: 'Onboard',      path: '/hr/onboard',      icon: UserPlus,     permission: 'hr' },
      { label: 'Leave',        path: '/hr/leave',        icon: Calendar,     permission: 'hr' },
      { label: 'Attendance',   path: '/hr/attendance',   icon: UserCheck,    permission: 'hr' },
      { label: 'Offboarding',  path: '/hr/offboarding',  icon: LogIn,        permission: 'hr' },
    ],
  },
  // HIDDEN - no backend yet
  /* {
