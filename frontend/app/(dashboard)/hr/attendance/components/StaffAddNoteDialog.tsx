...
export default function StaffAddNoteDialog({ staff, initialNote = '', onSave, onClose }: Props) {
      ...
      >
        ...
        <div className="px-5 py-4">
          <textarea
            ...
            maxLength={250}
            placeholder="Enter a note for this staff member..."
        ...
        <div className="flex items-center justify-end gap-2 px-5 py-3 border-t border-[#F0F0F6] bg-[#FAFAFD]">
          ...
          <button
            onClick={() => { if (note.trim()) onSave(note.trim()); }}
            disabled={!note.trim()}
