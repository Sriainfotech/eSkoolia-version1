...
export default function HrGlobalControls({
  selectedDate,
  onDateChange,
  searchQuery,
  onSearchChange,
    ...
    <div className="bg-white rounded-xl border border-[#E6E6EC] overflow-hidden mb-3">
      ...
      <div className="flex items-center gap-2.5 px-5 py-2.5 bg-white overflow-x-auto">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0 ml-auto">
          ...
          <button
            onClick={() => onMarkAllVisible("P")}
            disabled={allVisibleMarked}
            title={allVisibleMarked ? "All visible staff already marked" : "Mark all visible present"}
          ...
          <button
            ...
            title="Click twice to confirm marking ALL staff absent"
          ...
          <button
            onClick={() => onMarkAllVisible("L")}
            className="h-[30px] px-2.5 text-[11px] font-bold bg-[#EFF6FF] text-[#2563EB] rounded-lg border-none cursor-pointer hover:bg-[#2563EB] hover:text-white transition-colors"
          >
            L
          </button>
        </div>
